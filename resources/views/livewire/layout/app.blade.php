<div class="relative flex" x-data="{ collapsed: $wire.entangle('isCollapsed').live }">
    <aside class="fixed h-screen p-4 text-white transition-all duration-150 bg-gray-900"
        ...
        <ul>
            <li class="p-2 mb-2 rounded cursor-pointer {{ ($routeName ?: Route::currentRouteName()) === 'dashboard' ? ' bg-gray-700 ' : '' }}hover:bg-gray-700">
                <a href="{{ route('dashboard') }}" wire:navigate.prefetch class="flex items-center">
            ...
            <li class="p-2 mb-2 rounded cursor-pointer {{ ($routeName ?: Route::currentRouteName()) === 'absensi' ? ' bg-gray-700 ' : '' }} hover:bg-gray-700">
                <a href="{{ route('absensi') }}" wire:navigate.prefetch class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="m-1 size-6">
                        <path fill-rule="evenodd"
            ...
            <li class="p-2 mb-2 rounded cursor-pointer {{ ($routeName ?: Route::currentRouteName()) === 'worker' ? ' bg-gray-700 ' : '' }} hover:bg-gray-700">
                <a href="{{ route('worker') }}" wire:navigate.prefetch class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="m-1 size-6">
                        <path fill-rule="evenodd"
            ...
            <li class="p-2 mb-2 rounded cursor-pointer {{ ($routeName ?: Route::currentRouteName()) === 'report' ? ' bg-gray-700 ' : '' }} hover:bg-gray-700">
                <a href="{{ route('report') }}" wire:navigate.prefetch class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="m-1 size-6">
                        <path
