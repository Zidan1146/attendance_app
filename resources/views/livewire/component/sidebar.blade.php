<aside class="fixed h-screen p-4 text-white transition-all duration-150 bg-gray-900"
    ...
    <div class="flex flex-row justify-center w-full">
        <button wire:click="toggleSidebar" class="flex items-center p-2 mb-4 text-white rounded focus:outline-none hover:bg-gray-700">
        ...
        <h1 class="flex items-center justify-center mb-4 text-lg font-bold text-center w-full {{ $isCollapsed ? 'hidden' : 'block' }}">ABSENSI</h1>
    </div>

    <ul>
        <li class="flex items-center p-2 mb-2 bg-gray-700 rounded cursor-pointer">
        ...
        <li class="flex items-center p-2 mb-2 rounded cursor-pointer hover:bg-gray-700">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="m-1 size-6">
                <path fill-rule="evenodd"
